/*
 *  kernel_cfg.c
 *  Mon May 15 09:37:54 2023
 *  SG Version 2.00
 *  sg.exe ./Practica_1a.oil -os=ECC2 -I../ecrobot/../toppers_osek/sg/impl_oil -template=../ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( Avance ), TASKNAME( Final ), TASKNAME( Calibrar ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_Avance, (__STK_UNIT)_stack_Final, (__STK_UNIT)_stack_Calibrar, };
...
const AlarmType alarma = 0;

DeclareTask(Calibrar);
static void _activate_alarm_alarma( void );
static void _activate_alarm_alarma( void )
{ (void)ActivateTask( Calibrar ); }

const CounterType alminib_cntid[TNUM_ALARM] = { 0, };
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_alarma, };
