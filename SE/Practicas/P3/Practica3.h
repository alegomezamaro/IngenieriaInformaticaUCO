/******************************************************************************/
/* Practica3.h: Manejo de GPIO y Timers II.																		*/
...
#define	SIGNAL1_PIN_HIGH 	FIO4SET3 = 0x02;	// Pin señal 1 a alto 	P4.24
#define	SIGNAL1_PIN_LOW   FIO4CLR3 = 0x02;	// Pin señal 1 a bajo		P4.24	 
#include <LPC23xx.H>
/******************************************************************************/
/* delayT0Unlocked                                                            */
/******************************************************************************/
...
void delayT1Unlocked(unsigned int delayInDecimaMiliseg)
{
	...
	T1MR0 = delayInDecimaMiliseg * 12000000 / 10000;
